...
# Load data
trend_data <- read_csv("C:/Users/Wiji/Downloads/trend_data.csv")
trend_description <- read_csv("C:/Users/Wiji/Downloads/trend_description.csv")
...
ui <- fluidPage(theme = shinytheme("lumen"),
                ...
                )) #tutup sidebar layout #tutup fluid page
